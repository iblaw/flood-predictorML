...
export default function Home() {
  return (
    <div className="flex flex-col w-full min-h-[75vh] pt-32 pb-0">
      <section className="w-full max-w-5xl mx-auto px-4 pb-16 flex flex-col items-center justify-center text-center space-y-8 flex-1 z-10 relative">
        <motion.h1 
        ...
        >
          <Link
            ...
            target="_blank"
            className="border-2 border-black bg-black text-white px-8 py-4 font-bold text-lg hover:bg-zinc-800 hover:-translate-y-1 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all flex items-center justify-center gap-2"
          >
          ...
          <a
            ...
            className="border-2 border-black bg-yellow-400 text-black px-8 py-4 font-bold text-lg font-mono hover:bg-yellow-500 hover:-translate-y-1 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all flex items-center justify-center gap-2 uppercase"
          >
        ...
        >
          ...
          >
            <span className="border-b-[1.5px] border-blue-600 pb-1 group-hover:border-blue-800 transition-colors">Scroll down to read more about the project</span>
            <motion.svg 
      ...
      <section id="technical-stuff" className="flex flex-col gap-8 sm:gap-12 w-full pt-4 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-32">
