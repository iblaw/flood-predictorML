  ...
  return (
    <div className="relative inline-block text-left z-40" ref={dropdownRef}>
      <button
        ...
        className="shrink-0 bg-white border-4 border-black p-3 sm:px-6 sm:py-3 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex items-center justify-center font-mono text-sm uppercase font-bold hover:-translate-y-1 hover:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] transition-all active:translate-y-1 active:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
      >
        <Filter className="w-5 h-5" />
        <span className="hidden sm:inline ml-2">FILTER OPTIONS</span>
      </button>
